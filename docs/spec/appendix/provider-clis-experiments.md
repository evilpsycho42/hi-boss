# Appendix: Provider CLI Experiments

This appendix records manual CLI experiments and gotchas for the provider CLIs used by Hi-Boss.

Canonical “what Hi-Boss does” spec: `docs/spec/provider-clis.md`
