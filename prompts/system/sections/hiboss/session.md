...
{% if agent.sessionPolicy.dailyResetAt or agent.sessionPolicy.idleTimeout or agent.sessionPolicy.maxTokens %}
...
{% endif %}{% if agent.sessionPolicy.maxTokens %}- After {{ agent.sessionPolicy.maxTokens }} tokens used
{% endif %}
